% buid vector representation for all the images in dataset using SIFT
% features and tf-idf weighting.

function [image_feats, vocab_frequencies_in_DB] = build_vectors_for_images_in_dataset(image_paths)
